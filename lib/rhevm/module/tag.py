...
from rest.protocol import (ParseEntity, FormatEntity, TransformResource,
                           ReverseTransformResource)
...
def setup_module(app):
    ...
    app.add_output_filter(ReverseTransformResource(), action='attach_to_object')
